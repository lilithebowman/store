...
async function testHomePage() {
	...
	try {
		...
		const response = await fetch('http://localhost:2048/api/pages/slug/home');
		...
		const notFoundResponse = await fetch('http://localhost:2048/api/pages/slug/nonexistent');
		...
		console.log('   • Visit http://localhost:3000/admin/pages to manage pages');
		console.log('   • The home page should show full-width page builder content');
