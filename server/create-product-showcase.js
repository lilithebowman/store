	...
	try {
		...
		const productsToUse = products || [
			...
			},
			{
				...
				description:
					"Adjustable aluminum laptop stand designed for improved posture and airflow.",
				price: "49.99",
		...
		console.log(
			`🌐 Visit: http://localhost:3000/pages/${showcasePage.slug}`,
		);
...
if (args.length === 0) {
	...
	console.log(
		'Example: node create-product-showcase.js "Summer Collection 2025"',
	);
	process.exit(1);
}
