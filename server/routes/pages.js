...
router.post('/', authenticate, requirePermission('add_page'), pageController.createPage);

// Update page (requires edit_page permission)
router.put('/:id', authenticate, requirePermission('edit_page'), pageController.updatePage);

// Delete page (requires delete_page permission)
router.delete('/:id', authenticate, requirePermission('delete_page'), pageController.deletePage);
