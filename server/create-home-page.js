...
async function createHomePage() {
	try {
		...
		if (existingHomePage) {
			...
			console.log('🎨 Components:', existingHomePage.components?.length || 0);
			return;
		}
		...
		const defaultComponents = [
			...
			},
			{
				...
				componentId: 'text-block',
				props: {
					content: '<div style="text-align: center; padding: 40px 20px;"><div style="max-width: 400px; margin: 0 auto;"></div></div>'
				}
			},
			{
				id: 'shop-button',
